                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-evenly">
                      ...
                      <a href="/admin/datasiswa/{{ $siswa->id }}/edit" class="text-white btn btn-sm btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Siswa"><i class="fas fa-user-edit"></i></a>
                      {!! Form::open(['url' => '/admin/datasiswa/'.$siswa->id, 'method' => 'delete']) !!}
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 col-md-7" id="NISN"></div>
                </div>
                <div class="row">
